...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dataroot', type=str, default='./LEVIR-CD', help='path to images in the val phase (should have subfolders A, B, label)')
        ...
        parser.add_argument('--preprocess', type=str, default='rotate_flip', help='scaling and cropping of images at load time [resize_and_crop | none]')
