...
from SNUN.losses import hybrid_loss
from SNUN.SNUNet import SNUNet_ECAM
# baseline0 
class SNUNModel(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        self.netF = SNUNet_ECAM(in_ch=3, out_ch=2).to(self.device)
        if self.isTrain:
    ...
    def forward(self):
        self.dist = self.netF(self.A, self.B)[0]
