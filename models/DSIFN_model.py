...
# from . import loss
from DSIFN.loss import multi_supvised_loss
from DSIFN.DSIFNet import DSIFN

class DSIFNModel(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        self.n_class = 2
        self.netF = DSIFN().to(self.device)

        if self.isTrain:
            # define loss functions
            self.criterionF = multi_supvised_loss
